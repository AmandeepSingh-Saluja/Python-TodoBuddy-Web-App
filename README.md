...
1. **Clone the repository:**
    ```bash
    git clone https://github.com/AmandeepSingh-Saluja/Python-TodoBuddy-Web-App.git
    cd todoapp
    ```
...
- **Email:** : amandeepsalujaa@gmail.com
- **GitHub:** [Amandeep Singh Saluja](https://github.com/AmandeepSingh-Saluja/)
